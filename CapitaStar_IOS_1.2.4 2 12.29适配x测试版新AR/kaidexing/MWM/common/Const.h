...
#define PROTOCOLURL  @"https://passport.capitaland.com.cn/registerAgreement"
//门禁接口
...
//测试门禁参数
#define TOKENPARAMS  @{@"email":@"www@126.com",@"password":@"admin123"}

//正式门禁参数
//#define TOKENPARAMS  @{@"email":@"www@126.com",@"password":@"abc@123"}
